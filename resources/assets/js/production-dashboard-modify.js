...
$(window).on('load', function () {
    ...
    var mixedchartjsCOND2001 = document.getElementById('mixedchartjsCOND2001').getContext('2d');
    var gradient3 = mixedchartjsCOND2001.createLinearGradient(0, 0, 0, 450);
    gradient3.addColorStop(0, '#90b5ff');
    gradient3.addColorStop(0.5, 'rgba(152, 187, 255, 0)');

    var gradient4 = mixedchartjsCOND2001.createLinearGradient(0, 0, 0, 450);
    gradient4.addColorStop(0, '#5B92FF');
    gradient4.addColorStop(0.5, 'rgba(91, 146, 255, 0)');

    var configareachart3 = {
        type: 'line',
        data: {
            labels: ['0', 'Q1', 'Q2', 'Q3', 'Q4', 'Q5'],
            datasets: [{
    ...
    window.salesareachart2 = new Chart(mixedchartjsCOND2001, configareachart3);

    setInterval(function () {
        configareachart3.data.datasets.forEach(function (dataset) {
            dataset.data = dataset.data.map(function () {
                return randomScalingFactor();
            });

        });
        window.salesareachart2.update();
    }, 2600);
